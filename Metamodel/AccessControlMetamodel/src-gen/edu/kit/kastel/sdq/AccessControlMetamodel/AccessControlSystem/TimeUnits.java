 ...
 * <!-- end-user-doc -->
 * @see edu.kit.kastel.sdq.AccessControlMetamodel.AccessControlSystem.AccessControlSystemPackage#getTimeUnits()
 * @model
 * @generated
 */
public enum TimeUnits implements Enumerator {
	 ...
	 * @generated
	 */
	private static final TimeUnits[] VALUES_ARRAY = new TimeUnits[] { SECOND, MINUTE, HOUR, DAY, WEEK, YEAR, };
